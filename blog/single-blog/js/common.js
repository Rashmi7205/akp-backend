...
/* Agree to Terms */
$(document).delegate('.vagree', 'click', function(e) {
	e.preventDefault();
	$('#modal-agree').remove();
	...
	$.ajax({
		...
		success: function(data) {
			...
			html += '        <h4 class="modal-title">' + $(element).attr('data-attr') + '</h4>';
			html += '      </div>';
			html += '      <div class="modal-body">' + data + '</div>';
			html += '    </div>';
			html += '  </div>';
...
$(document).delegate(".cartagree", "click", function (e) {
    e.preventDefault();
    $("#modal-agree").remove();
    var element = this;
    $.ajax({
        ...
        success: function (data) {
           ...
           // html += '        <h4 class="modal-title">' + $(element).attr("data-attr") + "</h4>";
            html += "      </div>";
            html += '      <div class="modal-body px-5">' + data + "</div>";
            html += "    </div>";
            html += "  </div>";
            html += "</div>";
            $("body").append(html);
